  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <marquee><p class="login-box-msg">Harap Melakukan Logout Pada Halaman Sebelumnya</p></marquee>
        <form action="excecute/auth.php" method="post" name="login">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
                <input type="submit" name="login" class="btn btn-primary btn-block btn-flat" value="Sign In" disabled="">
