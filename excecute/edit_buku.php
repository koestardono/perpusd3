...
$sql	= "UPDATE tb_buku SET judul_buku='$judul_buku',id_pengarang='$id_pengarang',id_penerbit='$id_penerbit',jml_buku='$jumlah',tahunterbit='$tahun',no_rak='$rak' WHERE kd_buku='$kd_buku'";
