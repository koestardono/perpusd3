  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        ...
        <b><img src="images/logoperpus.png" width="100px" height="100px" class="pull-left">Perpustakaan Diploma III</b>
             </div><!-- /.login-logo -->
        ...
        <form action="excecute/auth.php" method="post" name="login">
          ...
          <div class="form-group has-feedback">      
            <select class="form-control select2" name="level">
              <option selected="selected" value="admin">Petugas</option>
              <option selected="selected" value="operator">Pimpinan</option>
