        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <?php
                            ...
                            $result = mysqli_query($connect, "SELECT tb_buku.*,tb_pengarang.*,tb_penerbit.*
                              ...
                              WHERE tb_buku.judul_buku like '%$kata%' OR tb_pengarang.nama_pengarang like '%$kata%'
                              ORDER BY tb_buku.kd_buku ASC
              ...
              // AND judul_buku like '%$kata%' OR nama_pengarang like '%$kata%'
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <?php
                            ...
                            // jalankan query
                            $result = mysqli_query($connect, "SELECT * FROM tb_anggota WHERE nm_anggota like '%$kata%' OR jurusan like '%$kata%'");
                  ...
                  <table id="example4" class="table table-bordered table-hover">
                    ...
                    <?php
                            ...
                            $result = mysqli_query($connect, "SELECT tb_pengembalian.*,tb_buku.*,tb_anggota.*
							  ...
							  AND nm_anggota like '%$kata%' or kd_pinjam like '%$kata%'");
