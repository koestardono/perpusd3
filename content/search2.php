                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td><a href="user.php?page=req_pinjam&judul_buku=<?php echo $row['judul_buku'];?>&id_anggota=<?php echo $_SESSION['id_anggota'];?>">
                            <span class="label label-success">Pinjam</span>
                            </a></td>
                        <td>
                          <?php if ($level == 'admin'){?>
                          <a href="admin.php?page=edit_Buku&id=<?php echo $row['kd_buku'];?>">
