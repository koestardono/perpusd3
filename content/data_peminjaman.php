                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td><?php $selisih = ((abs(strtotime ($row['tgl_pinjam']) - strtotime (date('Y-m-d'))))/(60*60*24)); echo $selisih;?> Hari <br>
                        ...
                        <td><?php 
                          ...
                          if ($selisih >= 6) {
                            ?>
                           <!-- <?php echo $row['email'];?> -->
                            <form action="content/kirimemail/index.php" method="get" class="table-hover">
            <div class="input-group">
              <input value="<?php echo $row['email'];?>" name="q" class="form-control" placeholder="Kirim Notifikasi...">
              <span class="input-group-btn">
                <button type="submit" id="search-btn" class="btn btn-flat"><i class="fa fa-send"></i></button>
              </span>
            </div>
          </form>
