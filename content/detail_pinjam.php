                  ...
                  <div class="box-body">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="hidden" name="kd_buku" value="<?php echo $row->kd_buku;?>" class="form-control">
                      </div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        ?>
                        <input type="text" value="Rp.<?php echo $denda;?>" required="" class="form-control" disabled="">
                        <input type="hidden" name="denda" value="<?php echo $denda;?>" required="" class="form-control">

                      </div>
                    </div>
				<!-- <div class="form-group">
                      <label class="col-sm-2 control-label">Telat</label>
                      <div class="col-sm-10">
                       
                        <input type="text" value="<?php echo $telat;?>" required="" class="form-control" disabled="">
                        <input type="hidden" name="denda" value="<?php echo $telat;?>" required="" class="form-control">
