                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <td>
                            <?php
                              if ($row['status']==0) {
                                echo '<center><a href="admin.php?page=terima_reqpinjam&no='.$row['no'].'" class="fa fa-check"></a>&nbsp;
                                  <a href="admin.php?page=tolak_requestpinjam&no='.$row['no'].'" class="fa fa-times-circle"></a></center>';
                              } elseif ($row['status']==1) {
                                echo '<center><a href="excecute/delete.php?dlt=dlreqpinjam&no='.$row['no'].'" class="fa fa-trash"></a></center>';
                              } else {
