        ...
        <section class="content">
          <div class="row">
            ...
            <label class="col-sm-2 control-label">ID Penerbit</label>
                      <div class="col-sm-10">
                        <input type="text" required="" value="<?php echo $row->id_penerbit;?>" class="form-control" placeholder="ID Penerbit" disabled="">
                        <input type="hidden" name="id_penerbit" value="<?php echo $row->id_penerbit;?>" required="" class="form-control" placeholder="ID Penerbit">
                      </div>
