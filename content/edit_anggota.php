        ...
        <section class="content">
          <div class="row">
            <div class="col-md-8">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <a href="user.php?page=cetak&id=<?php echo $row->id_anggota;?>" class="btn btn-primary">Cetak Kartu Anggota</a>
                </div><!-- /.box-header -->
                <!-- form start -->
            ...
            <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <img width="280" height="320" src="images/<?php echo $row->pasfoto;?>">
                      </div>
                    </div>
          <div class="form-group">
                      <label class="col-sm-2 control-label">Password</label>
                      <div class="col-sm-10">
                        <input type="text" name="password" value="<?php echo $row->password;?>" required="" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Pas Foto</label>
